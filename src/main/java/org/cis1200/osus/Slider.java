...
public class Slider extends Note {
    ...
    public void draw(Graphics g) {
        ...
        g.drawString("100", this.getPx() - metrics.stringWidth("100") / 2, this.getPy() - metrics.getHeight() / 2 + metrics.getAscent());

        // 50
        g.setColor(new Color(0, 100, 255, fiftyOpacity));
        g.drawString("50", this.getPx() - metrics.stringWidth("50") / 2, this.getPy() - metrics.getHeight() / 2 + metrics.getAscent());
